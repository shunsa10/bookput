  ...
  createStyles({
    root: {
      "& > *": {
        ...
        border: 0,
        borderRadius: 20,
        boxShadow: "0 3px 5px 2px #5878a84b",
        padding: "0 30px",
      },
    },
  })
    ...
    <NewgroupDiv>
      ...
      <Link to="UserHome" style={{ textDecoration: "none" }}>
        <NewGroupDiv2 className={classesButton.root}>
          <Button variant="outlined">グループに参加する</Button>
        </NewGroupDiv2>
      </Link>
    </NewgroupDiv>
  );
...
const NewgroupDiv = styled.div`
  ...
  padding: 30px 0;
  margin: 0 auto;
  background-image: url("./img/group/groupjoin1.jpeg");
